...
dns_child_zone                   = "apps"
azure_subscription_unitedstates  = "00000000-0000-0000-0000-000000000004"   # Enterprise Production Subscription
azure_subscription_europe        = "00000000-0000-0000-0000-000000000004"   # Enterprise Production Subscription
deploy_Europe                    = true # AKS is deployed
deploy_United_States             = false
#storage_account_replication_type = "GRS"
# acr_name_europe                  = "enterpriseappcrEurope"   # ACR deployed with terraform is currently disabled
# acr_name_unitedstates            = "enterpriseappcrUnitedStates"  # ACR deployed with terraform is currently disabled
...
# List of Developers with access to AKS (admin role to development namespaces)
aks_developers      = []

########################################
# Service Principals
########################################
service_principals_with_aad_aks_cluster_admin_role = [
    "sp-day2ops-Enterprise-pro",
    "sp-appcore-Enterprise-pro",
  ]