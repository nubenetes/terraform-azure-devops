...
client_names_europe                 = ["client7","client2","Enterprise","client8","client9","client10","client11","client12","client13","client14","client15","client16","client17","client18",
                                      "client19","client20"]
  # Enterprise = internal use by Enterprise for testing purposes
  # client9 = German Oncology Center
client_names_unitedstates           = ["client7"]
