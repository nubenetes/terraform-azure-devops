...
#acr_name_europe       = "DenterpriseappcrEurope"  # ACR deployed with terraform is currently disabled
#acr_name_unitedstates = "DenterpriseappcrUnitedStates"  # ACR deployed with terraform is currently disabled
